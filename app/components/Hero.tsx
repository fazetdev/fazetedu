...
export default function Hero() {
  ...
  const handleExplorePilot = () => {
    alert('Pilot features coming soon! Check back later.');
  };
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="space-x-4">
            <button 
              ...
              className="bg-[#059669] text-white px-8 py-3 rounded-lg font-bold text-lg hover:bg-[#047857]"
            >
              Join Our Pilot
            </button>
            <button 
              onClick={handleExplorePilot}
              className="bg-white text-[#10B981] px-8 py-3 rounded-lg font-bold text-lg hover:bg-gray-100 border-2 border-transparent"
            >
